...
function DocLinkMacros (context, docType) {
  return function () {
    this.process((parent, target, attrs) => {
      // console.log(attrs);
      console.log(this.getPositionalAttributes());
      console.log(this.getNamedAttributes());
      console.log(attrs.$positional);
      // console.log(this.positionalAttributes()); // not a function
      const text = this.positionalAttributes('display');
